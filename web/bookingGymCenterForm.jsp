                ...
                <div class="booking-wrapper">
                    ...
                    <form id="booking-form" method="post" action="cart">
                        ...
                        <input type="hidden" name="dispatch" 
                               value="gymCenter?action=getGymCenterByEnabled" />
                        <input type="hidden" name="bookingType" value="Gym Center" />
                        <input type="hidden" name="productId" value="<%=gymCenter.getId()%>"/>
                         <input type="hidden" name="location" value="<%=gymCenter.getLocation() %>"/>
                        <input type="hidden" name="name" value="<%=gymCenter.getName()%>"/>
                        <input type="hidden" name="hourlyRate" value="<%=gymCenter.getHourlyRate()%>"/>
                        <div class="mb-3">
        ...
        <script>
            $(document).ready(function () {
                $("input[name='bookingDate']").change(function () {
                    ...
                    window.location.href = "./gymCenter?action=getGymCenterBookingForm&id=" + id + "&bookingDate=" + bookingDate + "";
                });
            });
        </script>
    </body>
